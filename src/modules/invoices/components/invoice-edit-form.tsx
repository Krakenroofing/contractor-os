...
type LineDraft = {
   ...
   *  plain positive amount and the row SUBTRACTS it. Not persisted — a saved
   *  line is a deduction because its amount is negative. */
  isDeduction?: boolean;
};
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            onClick={() =>
              setLines((prev) => [
                ...prev,
                { ...newEmptyLine(), description: 'Less ', isDeduction: true },
              ])
            }
          >
